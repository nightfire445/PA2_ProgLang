...
public class InversionCount extends UniversalActor  {
	public static void main(String args[]) {
		...
		InversionCount instance = (InversionCount)new InversionCount(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new InversionCount(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return InversionCount.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new InversionCount(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return InversionCount.getReferenceByLocation(new UAL(ual)); }
	public InversionCount(boolean o, UAN __uan)	{ super(false,__uan); }
	public InversionCount(boolean o, UAL __ual)	{ super(false,__ual); }
	public InversionCount(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public InversionCount(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public InversionCount(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public InversionCount()		{  }
	public InversionCount(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "dna.InversionCount", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public InversionCount self;
		public void updateSelf(ActorReference actorReference) {
			((InversionCount)actorReference).setUAL(getUAL());
			((InversionCount)actorReference).setUAN(getUAN());
			self = new InversionCount(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "dna.InversionCount$State" );
		...
		public void act(String args[]) {
			if (args.length<2) {{
				System.out.println("Proper Usage is: salsa dna.DInversionCount input.txt theaters.txt");
				System.exit(0);
			}
